            ...
            <div class="card card-shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                        <button class="btn btn-success mb-2 mb-md-0" data-bs-toggle="modal"
                            ...
                            <tbody>
                                @forelse($students as $student)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ $student->photo_url }}" class="student-photo rounded-circle border"
                                                alt="{{ $student->name }}">
                                        </td>
                                        <td>{{ $student->name }}</td>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $student->Stats === 'Active' ? 'success' : 'danger' }}">
                                                {{ $student->Stats }}
                                            </span>
                                        </td>
                                        <td>
                                            <button class="btn btn-warning btn-sm edit-button" data-bs-toggle="modal"
                                                ...
                                                data-name="{{ $student->name }}" data-username="{{ $student->Username }}"
                                                data-password="{{ $student->Password }}"
                                                data-dob="{{ $student->dob->format('Y-m-d') }}"
                                                data-parent_name="{{ $student->Parent_Name }}"
                                                data-contact_no="{{ $student->Contact_No }}"
                                                data-email="{{ $student->Email }}" data-course_id="{{ $student->C_ID }}"
                                                data-address="{{ $student->Address }}" data-stats="{{ $student->Stats }}"
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mt-2">
                                    <img id="currentPhotoPreview" src="" class="img-thumbnail"
